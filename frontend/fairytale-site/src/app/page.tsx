...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-200 via-pink-200 to-orange-200 flex flex-col items-center justify-center px-6 relative">
      {/* Навигация */}
      ...
      {/* Контент */}
      <h1 className="text-4xl md:text-6xl font-extrabold text-purple-500 glow-text-3d text-center mb-6">
